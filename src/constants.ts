...
import { SystemDirectories, MultivalueParams, ParameterMap } from './types';
 ...
 */
export const systemDirectories: SystemDirectories = {
  os: {
    linux: ['.config'],
...
export const illegalChars: { [key: string]: RegExp } = {
  MSWin32: /[<>:"\/\\|?*\x00-\x1F]/,
  darwin: /[:]/,
  linux: /\//
};

export const onExistingOpts: { [key: string]: string } = {
  skip: 'LEAVE IT ALONE',
  merge: 'MERGE NEW PARAMETERS',
  overwrite: 'OVERWRITE'
};

export const filamentTypes: { [key: string]: string } = {
  PET: 'PETG',
  FLEX: 'TPU',
  NYLON: 'PA'
};

export const defaultMVS: { [key: string]: string } = {
  PLA: '15',
  PET: '10',
  ABS: '12',
  ASA: '12',
...
export const speedParams: { [key: string]: string } = {
...
export const seamPositions: { [key: string]: string } = {
  cost: 'nearest',
  random: 'random',
  allrandom: 'random',
  aligned: 'aligned',
...
export const infillTypes: { [key: string]: string } = {
...
export const supportStyles: { [key: string]: [string, string] } = {
  grid: ['normal', 'grid'],
  snug: ['normal', 'snug'],
  tree: ['tree', 'default'],
...
export const supportPatterns: { [key: string]: boolean } = {
  rectilinear: true,
...
export const interfacePatterns: { [key: string]: boolean } = {
  auto: true,
  rectilinear: true,
  concentric: true,
...
export const gcodeFlavors: { [key: string]: string } = {
  klipper: 'klipper',
...
export const hostTypes: { [key: string]: string } = {
  repetier: 'repetier',
  prusalink: 'prusalink',
...
export const zhopEnforcement: { [key: string]: string } = {
  'All surfaces': 'All Surfaces',
  'Not on top': 'Bottom Only',
  'Only on top': 'Top Only'
};

export const thumbnailFormat: { [key: string]: string } = {
  PNG: 'PNG',
  JPG: 'JPG',
  QOI: 'QOI',
  BIQU: 'BTT_TFT'
...
export const multivalueParams: MultivalueParams = {
