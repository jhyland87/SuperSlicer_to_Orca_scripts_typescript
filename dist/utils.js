...
exports.multivalueToArray = multivalueToArray;
exports.unbackslash = unbackslash;
exports.percentToFloat = percentToFloat;
exports.percentToMm = percentToMm;
exports.mmToPercent = mmToPercent;
exports.evaluatePrintOrder = evaluatePrintOrder;
exports.evaluateIroningType = evaluateIroningType;
exports.getOS = getOS;
exports.getHomeDir = getHomeDir;
exports.isOutputIniType = isOutputIniType;
exports.isValidIniType = isValidIniType;
/**
 ...
 * ```
 */
function multivalueToArray(inputString) {
    if (!inputString)
        return [];
 ...
 * ```
 */
function percentToFloat(subjectValue) {
...
function percentToMm(mmComparator, percentParam) {
    if (!mmComparator || !percentParam)
        return undefined;
    if (mmComparator === '' || percentParam === '')
        return undefined;
    if (!isPercent(percentParam))
        return percentParam;
    if (isPercent(String(mmComparator)))
        return undefined;
...
function mmToPercent(mmComparator, mmParam) {
    if (!mmComparator || !mmParam)
        return undefined;
    if (isPercent(mmParam))
        return mmParam;
    if (isPercent(String(mmComparator)))
        return undefined;
 ...
 * ```
 */
function evaluatePrintOrder(externalPerimetersFirst, infillFirst) {
 ...
 * ```
 */
function evaluateIroningType(ironing, ironingType) {
    if (ironing) {
 ...
 * ```
 */
function isOutputIniType(iniType) {
 ...
 * ```
 */
function isValidIniType(iniType) {
